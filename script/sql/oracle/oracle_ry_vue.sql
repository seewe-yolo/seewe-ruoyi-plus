...
insert into sys_menu values(1761400000000000006, 'AI会话',  0, 8, 'aichat', 'ai/chat/index', '', 'N', 'Y', 'C', '0', '0', '', 'tabler:message-chatbot', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, 'AI聊天菜单');
-- 二级菜单
