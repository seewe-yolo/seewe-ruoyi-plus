...
--changeset seewe:20260805-03-sqlserver-workflow-table endDelimiter:GO
--preconditions onFail:MARK_RAN
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = SCHEMA_NAME() AND table_name = 'flow_definition'
