...
--changeset seewe:20260805-02-postgresql-job-data
--preconditions onFail:MARK_RAN
--precondition-sql-check expectedResult:1 SELECT COUNT(*) FROM DATABASECHANGELOG WHERE ID = '20260805-02-postgresql-job-table' AND AUTHOR = 'seewe' AND EXECTYPE = 'EXECUTED'
...
INSERT INTO sys_menu VALUES (1761400000000000120, '任务调度中心', 1761400000000000002, 6, 'snailjob', 'monitor/snailjob/index', '', 'N', 'Y', 'C', '0', '0', 'monitor:snailjob:list', 'gridicons:scheduled', '', '', 1761000000000000103, 1761100000000000001, now(), NULL, NULL, 'SnailJob控制台菜单');
