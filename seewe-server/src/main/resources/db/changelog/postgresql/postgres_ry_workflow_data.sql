...
--changeset seewe:20260805-03-postgresql-workflow-data
--preconditions onFail:MARK_RAN
--precondition-sql-check expectedResult:1 SELECT COUNT(*) FROM DATABASECHANGELOG WHERE ID = '20260805-03-postgresql-workflow-table' AND AUTHOR = 'seewe' AND EXECTYPE = 'EXECUTED'
